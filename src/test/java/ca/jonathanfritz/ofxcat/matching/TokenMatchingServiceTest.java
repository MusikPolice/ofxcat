...
class TokenMatchingServiceTest extends AbstractDatabaseTest {
    ...
    void setUpTestData() {
        ...
        tokenMatchingService =
                new TokenMatchingService(connection, transactionTokenDao, categoryDao, tokenNormalizer, config);
    ...
    void exactTokenMatchReturnsCategory() throws SQLException {
        ...
        createTransactionWithTokens("STARBUCKS #4756", restaurants, Set.of("starbucks"));

        // Execute: Search for matching categories
        List<TokenMatchingService.CategoryMatch> matches =
                tokenMatchingService.findMatchingCategories(Set.of("starbucks"));
    ...
    void subsetTokenMatchReturnsCategory() throws SQLException {
        ...
        createTransactionWithTokens("SHOPPERS DRUG MART", groceries, Set.of("shoppers", "drug", "mart"));

        // Execute: Search with a subset of tokens
        List<TokenMatchingService.CategoryMatch> matches =
                tokenMatchingService.findMatchingCategories(Set.of("shoppers", "drug"));
    ...
    void noMatchReturnsEmpty() throws SQLException {
        ...
        createTransactionWithTokens("STARBUCKS", restaurants, Set.of("starbucks"));

        // Execute: Search with completely different tokens
        List<TokenMatchingService.CategoryMatch> matches =
                tokenMatchingService.findMatchingCategories(Set.of("walmart", "grocery"));
    ...
    void multipleMatchesRankedByOverlap() throws SQLException {
        ...
        createTransactionWithTokens("TIM HORTONS COFFEE", restaurants, Set.of("tim", "hortons", "coffee"));
        createTransactionWithTokens("STARBUCKS COFFEE", restaurants, Set.of("starbucks", "coffee"));

        // Execute: Search with "coffee" - both should match
        List<TokenMatchingService.CategoryMatch> matches =
                tokenMatchingService.findMatchingCategories(Set.of("coffee"));
    ...
    void respectsThresholdConfiguration() throws SQLException {
        ...
        final TokenMatchingConfig strictConfig =
                TokenMatchingConfig.builder().overlapThreshold(1.0).build();
        final TokenMatchingService strictService =
                new TokenMatchingService(connection, transactionTokenDao, categoryDao, tokenNormalizer, strictConfig);
        ...
        final TokenMatchingConfig looseConfig =
                TokenMatchingConfig.builder().overlapThreshold(0.5).build();
        final TokenMatchingService looseService =
                new TokenMatchingService(connection, transactionTokenDao, categoryDao, tokenNormalizer, looseConfig);
    ...
    void emptyTokensReturnsEmpty() {
        ...
        List<TokenMatchingService.CategoryMatch> matches = tokenMatchingService.findMatchingCategories(Set.of());
    ...
    void ignoresUnknownCategory() throws SQLException {
        ...
        List<TokenMatchingService.CategoryMatch> matches = tokenMatchingService.findMatchingCategories(searchTokens);
    ...
    void walmartLocationsMatchSameCategory() throws SQLException {
        ...
        createTransactionWithTokens("WAL-MART #1155", groceries, Set.of("walmart"));
    ...
    void aggregatesMatchesByCategory() throws SQLException {
        ...
        createTransactionWithTokens("STARBUCKS #4756", restaurants, Set.of("starbucks"));
        createTransactionWithTokens("STARBUCKS #1234", restaurants, Set.of("starbucks"));
    ...
    void findMatchingCategoriesForDescription() throws SQLException {
        ...
        List<TokenMatchingService.CategoryMatch> matches =
                tokenMatchingService.findMatchingCategoriesForDescription("STARBUCKS 800-782-7282");
    ...
    private void createTransactionWithTokens(String description, Category category, Set<String> tokens)
            throws SQLException {
        ...
        try (DatabaseTransaction t = new DatabaseTransaction(connection)) {
            final CategorizedTransaction categorizedTxn = categorizedTransactionDao
                    .insert(t, new CategorizedTransaction(txn, category))
                    .orElseThrow();
