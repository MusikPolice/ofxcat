...
class AmountMatcherRuleTest {
    ...
    public void isEqualToTest() {
        ...
        OfxTransaction ofxTransaction =
                OfxTransaction.newBuilder().setAmount(5.01f).build();
        assertThat(rule.match(ofxTransaction), IsEqual.equalTo(true));

        // no match
        ofxTransaction = OfxTransaction.newBuilder().setAmount(6.99f).build();
    ...
    public void isGreaterThanTest() {
        ...
        OfxTransaction ofxTransaction =
                OfxTransaction.newBuilder().setAmount(6.99f).build();
        assertThat(rule.match(ofxTransaction), IsEqual.equalTo(true));

        // no match
        ofxTransaction = OfxTransaction.newBuilder().setAmount(4.99f).build();
        assertThat(rule.match(ofxTransaction), IsEqual.equalTo(false));

        // no match
        ofxTransaction = OfxTransaction.newBuilder().setAmount(5.01f).build();
        assertThat(rule.match(ofxTransaction), IsEqual.equalTo(false));
    }
    ...
    public void isLessThanTest() {
        ...
        OfxTransaction ofxTransaction =
                OfxTransaction.newBuilder().setAmount(4.99f).build();
        assertThat(rule.match(ofxTransaction), IsEqual.equalTo(true));
