...
class TransactionMatcherRuleTest {
    ...
    public void typeMatcherTest() {
        ...
        OfxTransaction ofxTransaction =
                OfxTransaction.newBuilder().setType(TransactionType.DEBIT).build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(true));

        // no match
        ofxTransaction =
                OfxTransaction.newBuilder().setType(TransactionType.CREDIT).build();
    ...
    public void amountMatcherTest() {
        ...
        // match
        OfxTransaction ofxTransaction =
                OfxTransaction.newBuilder().setAmount(5.00f).build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(true));

        // no match
        ofxTransaction = OfxTransaction.newBuilder().setAmount(6.00f).build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(false));
    }
    ...
    public void nameMatcherTest() {
        ...
        // match
        OfxTransaction ofxTransaction =
                OfxTransaction.newBuilder().setName("Hello World").build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(true));

        // no match
        ofxTransaction = OfxTransaction.newBuilder().setName("Goodbye World").build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(false));
    }
    ...
    public void memoMatcherTest() {
        ...
        // match
        OfxTransaction ofxTransaction =
                OfxTransaction.newBuilder().setMemo("Hello World").build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(true));

        // no match
        ofxTransaction = OfxTransaction.newBuilder().setMemo("Goodbye World").build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(false));
    }
    ...
    public void multipleMatcherLogicalAndTest() {
        ...
        // no match
        ofxTransaction = OfxTransaction.newBuilder().setMemo("Hello World").build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(false));

        ofxTransaction = OfxTransaction.newBuilder().setAmount(100f).build();
        assertThat(rule.matches(ofxTransaction), IsEqual.equalTo(false));
    }
}
