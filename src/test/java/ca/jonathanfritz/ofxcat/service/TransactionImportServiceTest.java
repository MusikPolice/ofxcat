...
class TransactionImportServiceTest {
    ...
    void categorizeTransactionsUnknownAccountSuccessTest() throws SQLException {
        ...
        final Set<CategorizedTransaction> categorizedTransactions = transactionImportService.categorizeTransactions(transactionMap);
    ...
    void categorizeTransactionsUnknownAccountInsertFailsTest() {
        ...
        try {
            ...
            transactionImportService.categorizeTransactions(transactionMap);
